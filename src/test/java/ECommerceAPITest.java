...
//SSL
	...
	loginRequest.setUserEmail("rhasnatest1@gmail.com");
	loginRequest.setUserPassword("Testing123@");
	...
	RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq).param("productName", "Laptop Hasan")
	.param("productAddedBy", userId).param("productCategory", "fashion")
	.param("productSubCategory", "shirts").param("productPrice", "11500")
	.param("productDescription", "Lenova").param("productFor", "men")
	.multiPart("productImage",new File("\\Users\\Mufti Sariawan\\Downloads\\gambar1.jpeg"));
